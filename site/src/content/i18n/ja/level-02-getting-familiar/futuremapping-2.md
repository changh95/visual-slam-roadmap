...
- [Factor graph](factor-graph.md) — GBPが動作する表現
- [MAP inference as sparse nonlinear least squares](map-inference-as-sparse-nonlinear-least-squares.md) — GBPが置き換える集中型の定式化
