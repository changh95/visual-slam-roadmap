...
- [Factor graph](../level-02-getting-familiar/factor-graph.md) — 基盤となる表現
- [Incremental smoothing](../level-02-getting-familiar/incremental-smoothing.md) — 集中型の逐次的な代替手法(iSAM2)
- [Bundle adjustment](../level-02-getting-familiar/bundle-adjustment.md) — 解かれている問題そのもの
