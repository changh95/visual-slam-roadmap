...
- [Factor graph](../level-02-getting-familiar/factor-graph.md) — GBP所操作的表示形式
- [MAP inference as sparse nonlinear least squares](../level-02-getting-familiar/map-inference-as-sparse-nonlinear-least-squares.md) — GBP所取代的集中式表述方式
