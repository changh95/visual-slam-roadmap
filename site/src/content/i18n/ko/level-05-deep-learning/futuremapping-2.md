...
- [Factor graph](../level-02-getting-familiar/factor-graph.md) — GBP가 동작하는 표현
- [MAP inference as sparse nonlinear least squares](../level-02-getting-familiar/map-inference-as-sparse-nonlinear-least-squares.md) — GBP가 대체하는 중앙집중식 형식화
