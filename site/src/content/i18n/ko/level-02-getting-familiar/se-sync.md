...
- [Pose graph optimization](pose-graph-optimization.md) — 인증되는 대상 문제
- [MAP inference as sparse nonlinear least squares](map-inference-as-sparse-nonlinear-least-squares.md) — 완화되는 MLE 공식
