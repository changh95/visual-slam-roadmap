...
- [Factor graph](factor-graph.md) — the representation GBP operates on
- [MAP inference as sparse nonlinear least squares](map-inference-as-sparse-nonlinear-least-squares.md) — the centralized formulation GBP replaces
