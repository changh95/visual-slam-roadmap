...
- [Factor graph](factor-graph.md) — the underlying representation
- [Incremental smoothing](incremental-smoothing.md) — the centralized incremental alternative (iSAM2)
- [Bundle adjustment](bundle-adjustment.md) — the problem being solved
