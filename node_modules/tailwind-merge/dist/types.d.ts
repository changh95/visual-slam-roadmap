...
interface Config<ClassGroupIds extends string, ThemeGroupIds extends string> extends ConfigStatic, ConfigGroups<ClassGroupIds, ThemeGroupIds> {
}
...
interface ConfigExtension<ClassGroupIds extends string, ThemeGroupIds extends string> extends Partial<ConfigStatic> {
...
type CreateConfigSubsequent$1 = (config: GenericConfig) => GenericConfig;
...
declare function isLength(value: string): boolean;
declare function isArbitraryLength(value: string): boolean;
declare function isNumber(value: string): boolean;
declare function isArbitraryNumber(value: string): boolean;
declare function isInteger(value: string): boolean;
declare function isPercent(value: string): boolean;
declare function isArbitraryValue(value: string): boolean;
declare function isTshirtSize(value: string): boolean;
declare function isArbitrarySize(value: string): boolean;
declare function isArbitraryPosition(value: string): boolean;
declare function isArbitraryImage(value: string): boolean;
declare function isArbitraryShadow(value: string): boolean;
...
declare function getDefaultConfig(): {
    ...
    readonly theme: {
        ...
        readonly spacing: readonly [typeof isLength, typeof isArbitraryLength];
        ...
        readonly borderSpacing: readonly [typeof isArbitraryValue, ThemeGetter];
        readonly borderWidth: readonly ["", typeof isLength, typeof isArbitraryLength];
        ...
        readonly gap: readonly [typeof isArbitraryValue, ThemeGetter];
        ...
        readonly inset: readonly ["auto", typeof isArbitraryValue, ThemeGetter];
        readonly margin: readonly ["auto", typeof isArbitraryValue, ThemeGetter];
        readonly opacity: (typeof isNumber)[];
        readonly padding: readonly [typeof isArbitraryValue, ThemeGetter];
        ...
        readonly space: readonly [typeof isArbitraryValue, ThemeGetter];
        readonly translate: readonly [typeof isArbitraryValue, ThemeGetter];
    };
    readonly classGroups: {
         ...
         */
        readonly z: readonly [{
            readonly z: readonly ["auto", typeof isInteger, typeof isArbitraryValue];
        }];
        /**
         * Flex Basis
        ...
        readonly basis: readonly [{
            readonly basis: readonly ["auto", typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Flex Direction
        ...
        readonly order: readonly [{
            readonly order: readonly ["first", "last", "none", typeof isInteger, typeof isArbitraryValue];
        }];
        /**
        ...
        readonly 'col-start-end': readonly [{
            readonly col: readonly ["auto", {
                readonly span: readonly ["full", typeof isInteger, typeof isArbitraryValue];
        ...
        readonly 'row-start-end': readonly [{
            readonly row: readonly ["auto", {
                readonly span: readonly [typeof isInteger, typeof isArbitraryValue];
            }, typeof isArbitraryValue];
        }];
        /**
         * Grid Row Start
         ...
         */
        readonly w: readonly [{
            readonly w: readonly ["auto", "min", "max", "fit", "svw", "lvw", "dvw", typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Min-Width
        ...
        readonly 'min-w': readonly [{
            readonly 'min-w': readonly [typeof isArbitraryValue, ThemeGetter, "min", "max", "fit"];
        }];
        /**
         * Max-Width
        ...
        readonly 'max-w': readonly [{
            readonly 'max-w': readonly [typeof isArbitraryValue, ThemeGetter, "none", "full", "min", "max", "fit", "prose", {
         ...
         */
        readonly h: readonly [{
            readonly h: readonly [typeof isArbitraryValue, ThemeGetter, "auto", "min", "max", "fit", "svh", "lvh", "dvh"];
        }];
        /**
         * Min-Height
        ...
        readonly 'min-h': readonly [{
            readonly 'min-h': readonly [typeof isArbitraryValue, ThemeGetter, "min", "max", "fit", "svh", "lvh", "dvh"];
        }];
        /**
         * Max-Height
        ...
        readonly 'max-h': readonly [{
            readonly 'max-h': readonly [typeof isArbitraryValue, ThemeGetter, "min", "max", "fit", "svh", "lvh", "dvh"];
        }];
        /**
         * Size
        ...
        readonly size: readonly [{
            readonly size: readonly [typeof isArbitraryValue, ThemeGetter, "auto", "min", "max", "fit"];
        }];
        /**
         * Font Size
        ...
        readonly leading: readonly [{
            readonly leading: readonly ["none", "tight", "snug", "normal", "relaxed", "loose", typeof isLength, typeof isArbitraryValue];
        }];
        /**
         * List Style Image
        ...
        readonly 'text-decoration-thickness': readonly [{
            readonly decoration: readonly ["auto", "from-font", typeof isLength, typeof isArbitraryLength];
        }];
        /**
        ...
        readonly 'underline-offset': readonly [{
            readonly 'underline-offset': readonly ["auto", typeof isLength, typeof isArbitraryValue];
        }];
        /**
        ...
        readonly indent: readonly [{
            readonly indent: readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Vertical Alignment
        ...
        readonly 'outline-offset': readonly [{
            readonly 'outline-offset': readonly [typeof isLength, typeof isArbitraryValue];
        }];
        /**
         * Outline Width
        ...
        readonly 'outline-w': readonly [{
            readonly outline: readonly [typeof isLength, typeof isArbitraryLength];
        }];
        /**
         * Outline Color
        ...
        readonly 'ring-w': readonly [{
            readonly ring: readonly ["", typeof isLength, typeof isArbitraryLength];
        }];
        /**
         * Ring Width Inset
         * @see https://tailwindcss.com/docs/ring-width
        ...
        readonly 'ring-offset-w': readonly [{
            readonly 'ring-offset': readonly [typeof isLength, typeof isArbitraryLength];
        }];
        /**
         * Ring Offset Color
        ...
        readonly 'scroll-m': readonly [{
            readonly 'scroll-m': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Margin X
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mx': readonly [{
            readonly 'scroll-mx': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Margin Y
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-my': readonly [{
            readonly 'scroll-my': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Margin Start
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-ms': readonly [{
            readonly 'scroll-ms': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Margin End
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-me': readonly [{
            readonly 'scroll-me': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Margin Top
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mt': readonly [{
            readonly 'scroll-mt': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Margin Right
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mr': readonly [{
            readonly 'scroll-mr': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-mb': readonly [{
            readonly 'scroll-mb': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Margin Left
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-ml': readonly [{
            readonly 'scroll-ml': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Padding
        ...
        readonly 'scroll-p': readonly [{
            readonly 'scroll-p': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Padding X
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-px': readonly [{
            readonly 'scroll-px': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Padding Y
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-py': readonly [{
            readonly 'scroll-py': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-ps': readonly [{
            readonly 'scroll-ps': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Padding End
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-pe': readonly [{
            readonly 'scroll-pe': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Padding Top
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-pt': readonly [{
            readonly 'scroll-pt': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-pr': readonly [{
            readonly 'scroll-pr': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-pb': readonly [{
            readonly 'scroll-pb': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Padding Left
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-pl': readonly [{
            readonly 'scroll-pl': readonly [typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Scroll Snap Align
        ...
        readonly 'stroke-w': readonly [{
            readonly stroke: readonly [typeof isLength, typeof isArbitraryLength, typeof isArbitraryNumber];
        }];
        /**
         * Stroke
...
export { type ClassNameValue, type ClassValidator, type Config, type DefaultClassGroupIds, type DefaultThemeGroupIds, createTailwindMerge, extendTailwindMerge, fromTheme, getDefaultConfig, mergeConfigs, twJoin, twMerge, validators_d as validators };
