...
class WebServerPlugin {
  ...
  async _startProcess() {
    ...
    launchedProcess.stderr.on('data', line => {
      var _onStdErr, _ref;
      if (debugWebServer.enabled || this._options.stderr === 'pipe' || !this._options.stderr) (_onStdErr = (_ref = this._reporter).onStdErr) === null || _onStdErr === void 0 ? void 0 : _onStdErr.call(_ref, _utilsBundle.colors.dim('[WebServer] ') + line.toString());
    });
    launchedProcess.stdout.on('data', line => {
      var _onStdOut, _ref2;
      if (debugWebServer.enabled || this._options.stdout === 'pipe') (_onStdOut = (_ref2 = this._reporter).onStdOut) === null || _onStdOut === void 0 ? void 0 : _onStdOut.call(_ref2, _utilsBundle.colors.dim('[WebServer] ') + line.toString());
    });
  }
