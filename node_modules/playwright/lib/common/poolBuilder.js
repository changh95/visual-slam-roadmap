...
class PoolBuilder {
  ...
  _buildTestTypePool(testType, testErrors) {
    if (!this._testTypePools.has(testType)) {
      var _this$_project$projec, _this$_project, _this$_project$projec2, _this$_project2;
      const optionOverrides = {
        overrides: (_this$_project$projec = (_this$_project = this._project) === null || _this$_project === void 0 ? void 0 : (_this$_project$projec2 = _this$_project.project) === null || _this$_project$projec2 === void 0 ? void 0 : _this$_project$projec2.use) !== null && _this$_project$projec !== void 0 ? _this$_project$projec : {},
        location: {
