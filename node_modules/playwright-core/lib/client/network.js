...
class Request extends _channelOwner.ChannelOwner {
  ...
  _targetClosedScope() {
    var _this$serviceWorker, _frame$_page;
    const frame = _frame.Frame.fromNullable(this._initializer.frame);
    return ((_this$serviceWorker = this.serviceWorker()) === null || _this$serviceWorker === void 0 ? void 0 : _this$serviceWorker._closedScope) || (frame === null || frame === void 0 ? void 0 : (_frame$_page = frame._page) === null || _frame$_page === void 0 ? void 0 : _frame$_page._closedOrCrashedScope) || new _manualPromise.LongStandingScope();
  }
}
...
class Route extends _channelOwner.ChannelOwner {
  ...
  async fetch(options = {}) {
    return await this._wrapApiCall(async () => {
      return this._context.request._innerFetch({
